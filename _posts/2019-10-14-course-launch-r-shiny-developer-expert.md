...
__Expert Shiny Developer with AWS__ is an innovative course designed to teach data scientists and programmers how to build and deploy production-ready applications in the cloud using `R`, `Shiny` and `AWS`. 
