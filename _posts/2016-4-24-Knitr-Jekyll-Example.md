...
{% highlight r %}
# generate a table
knitr::kable(head(mtcars[,c(1,2,3,4)]))
{% endhighlight %}
...
![A scatterplot of the cars data](/figure/source/2016-4-24-Knitr-Jekyll-Example/cars-1.png)

## The build script

A Zero-configuration is required for `servr::jekyll()` to work on your Jekyll website. However, there is always demand for more control over some options, which can be defined in a custom build script. Here are the arguments of `servr::jekyll()`:
