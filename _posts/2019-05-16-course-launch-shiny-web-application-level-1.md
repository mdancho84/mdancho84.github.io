...
- ___2 Web Apps That You Can Productionalize ($5000 value)___
    
    - ___Sales Dashboard___ - Exposes you to Geographic and Time Series data along with learning reactive programming with Shiny
    - ___Product Prediction Application___ - Integrates Machine Learning (XGBoost) and advanced visualizations

- ___Hundreds of Resources ($1000 value)___:

    - ___ULTIMATE R CHEAT SHEET___ - The New & Improved Version 2.0
