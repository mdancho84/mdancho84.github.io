...
## List of 2
##  $ src    : chr "yahoo"
##  $ updated: POSIXct[1:1], format: "2016-10-23 13:49:19"
{% endhighlight %}
...
The [sp500_analysis_tutorial.R](https://github.com/mdancho84/quantitative_stock_analysis_tutorial) file is available on _GitHub_. The `.R` file has everything needed to generate the `plotly` and `corrplot` visualizations. Depending on your PC processing power, it should take just a minute or two to run.  
