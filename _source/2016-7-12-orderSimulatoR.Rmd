...
Nice. Cannondale has a general growth trend. It looks like `r salesByYear[which.max(salesByYear$total.sales), 1]` was Cannondale's best year with `r scales::dollar(max(salesByYear$total.sales))` in total sales, and 2015 almost matched it! 
